	...
	theme: {
		...
		extend: {
			...
			maxWidth: {
				unset: 'unset',
				...px2remMap([
					170, 248, 289, 276, 318, 319, 394, 403, 422, 450, 490, 493,
					500, 550, 605, 606, 718, 733, 818, 894, 960, 1028, 1080,
					1240,
				]),
				'7/10': '70%',
				'4/5': '80%',
			...
			height: {
				...px2remMap([
					6, 13, 14, 16, 20, 26, 34, 42, 45, 46, 48, 52, 54, 68, 72, 78,
					84, 100, 104, 106, 128, 133, 138, 140, 160, 200, 240, 250,
					292, 302, 328, 375, 412, 430, 436, 440, 445, 490, 503, 510, 534,
					546, 550, 600, 670, 706, 737, 750, 820,
				]),
			},
			fontSize: px2remMap([
