...
class Fundraiser_Quiz extends A_Options_Page {
	...
	protected static function prepare_fields(): array {
		...
		return array_merge(
			...
			[
				static::DEV_INQ_FORM_TITLE => [
					'key'                    => $dev_inq_form_title,
					'name'                   => static::DEV_INQ_FORM_TITLE,
					'label'                  => 'Title',
					'type'                   => 'text',
				],
				static::DEV_INQ_FORM_DESCRIPTION => [
				...
				static::DEV_INQ_FORM_REASONS => [
					...
					'sub_fields'             => [
						static::DEV_INQ_FORM_REASONS_ITEM => [
			...
			[
				static::CREATE_FUNDRAISER_TITLE => [
				...
				static::CREATE_FUNDRAISER_BUTTON => [
				...
				static::CREATE_FUNDRAISER_CARD_TITLE => [
				...
				static::CREATE_FUNDRAISER_CARD_DESCRIPTION => [
				...
				static::CREATE_FUNDRAISER_CARD_LINKS => [
					...
					'sub_fields'    => [
						static::CREATE_FUNDRAISER_CARD_LINK_TYPE => [
						...
						static::CREATE_FUNDRAISER_CARD_LINK => [
						...
						static::CREATE_FUNDRAISER_CARD_FILE_LINK_GROUP => [
			...
			[
				static::COLLECT_DONATIONS_TITLE => [
			...
			[
				...
				static::WHO_FUNDRAISING_CHOICES => [
			...
			[
				static::PLANNING_GATHERING_TITLE => [
	...
	protected static function step_one ( array $data = [] ): string {
		ob_start();
		?>
	...
	protected static function form ( array $data = [] ): string {
		ob_start();
		?>
			<div class="fundraiser-quiz--form fundraiser-quiz--steps" data-vertex="form">
					...
					<div class="fundraiser-quiz__fields">
						...
						<select class="fundraiser-quiz__inquiry" name="inquiry-reason" id="inquiry-reason">
							...
							<?php if ( ! empty( $data['inquiry_reasons'] ) ) {
	...
	protected static function create_fundraiser ( array $data = [] ): string {
		ob_start();
		?>
						...
						<ul class="fundraiser-quiz__get-your-fundraiser-links">
							<?php foreach ( $data['card_links'] as $link ) { ?>
								<li class="fundraiser-quiz__get-your-fundraiser-link">
									<a class="wave-underline" target="<?php echo $link['target'] ?: ''; ?>" href="<?php echo esc_attr( $link['url'] ); ?>" <?php if ( $link['type'] === 'file' ) echo "download"; ?>><?php echo esc_html( $link['title'] ); ?></a>
								</li>
							<?php } ?>
						</ul>
					<?php } ?>
	...
	protected static function collect_donations ( array $data = [] ): string {
		ob_start();
		?>
	...
	protected static function who_is_fundraising ( array $data = [] ): string {
		ob_start();
		?>
	...
	protected static function gathering ( array $data = [] ): string {
		ob_start();
		?>
