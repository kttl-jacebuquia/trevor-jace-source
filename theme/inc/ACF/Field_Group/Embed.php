...
class Embed extends A_Field_Group implements I_Block, I_Renderable {
    ...
    protected static function prepare_register_args(): array {
        ...
        return [
                ...
                'fields' => [
                    ...
                    static::FIELD_EMBED_URL => [
                        'key'           => $embed_url,
                        'name'          => static::FIELD_EMBED_URL,
                        'label'         => 'Embed',
                        'type'          => 'oembed',
                    ],
                    static::FIELD_ASPECT_RATIO => [
                        'key'           => $aspect_ratio,
    ...
    public static function render( $post = false, array $data = null, array $options = [] ): ?string {
        ...
        $wrapper_cls = [ 'embed flex flex-col justify-center items-center flex-nowrap' ];
        ...
        $heading_cls = [ 'embed-heading text-center font-bold' ];
        ...
        $embed_cls = [ 'embed-content w-full' ];
        ...
        <div class="<?= $wrapper_cls ?>">
            <h2 class="<?= $heading_cls ?>"><?= $heading ?></h2>
            <div class="<?= $embed_cls ?>" <?= $attrs_string ?>>
                <?= $embed ?>
            </div>
        </div>
