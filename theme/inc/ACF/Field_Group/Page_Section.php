...
class Page_Section extends A_Basic_Section implements I_Block {
	...
	protected static function _get_fields(): array {
		...
		return array_merge( parent::_get_fields(), [
			static::FIELD_WRAPPER_ATTR => DOM_Attr::clone(),
			static::FIELD_TEXT_CLR     => Field\Color::gen_args( $text_clr, static::FIELD_TEXT_CLR, [ 'label' => 'Text Color' ] ),
			static::FIELD_BG_CLR       => Field\Color::gen_args( $bg_clr, static::FIELD_BG_CLR, [ 'label' => 'Text Color' ] ),
		] );
	}
