...
class Post_Carousel extends Post_Grid {
	...
	public static function render( $post = false, array $data = null, array $options = array() ): ?string {
		...
		$post_types      = $val->get( static::FIELD_QUERY_PTS ) ? false : array();
		...
		ob_start(); ?>
		<div <?php echo esc_html( Tools::flat_attr( $wrapper_attrs ) ); ?>>
			<?php echo esc_html( Helper\Carousel::posts( $posts, $options ) ); ?>
		</div>
		<?php
		return ob_get_clean();
	}
