...
class Shop_Product_Partners extends Abstract_Customizer {
	...
	protected function _register_panels(): void {
		$this->_manager->add_panel( self::PANEL_ID, array( 'title' => 'Shop our Product Partners' ) );
	}
	...
	protected function _register_controls(): void {
		...
		$this->_manager->add_control(
			self::SETTING_HOME_HERO_TITLE_TOP,
			array(
		...
		$this->_manager->add_control(
			new Control\Custom_List(
				$this->_manager,
				self::SETTING_HOME_HERO_CAROUSEL,
				array(
		...
		// Featured
		$this->_manager->add_control(
			self::SETTING_HOME_STORIES_TITLE,
			array(
		...
		// Banner
		$this->_manager->add_control(
			self::SETTING_HOME_BANNER_TITLE,
			array(
