...
class Site_Banners extends Abstract_Customizer {
	...
	protected function _register_panels(): void {
		$this->_manager->add_panel( self::PANEL_ID, [ 'title' => 'Site Banners' ] );
	}
	...
	protected function _register_controls(): void {
		# Long Wait
		$this->_manager->add_control( self::SETTING_LONG_WAIT_URL, [
		...
		$this->_manager->add_control( self::SETTING_LONG_WAIT_FORCE, [
		...
		$this->_manager->add_control( self::SETTING_LONG_WAIT_TITLE, [
		...
		$this->_manager->add_control( self::SETTING_LONG_WAIT_DESC, [
		...
		# Custom
		$this->_manager->add_control( new Custom_List( $this->_manager, self::SETTING_CUSTOM_DATA, [
