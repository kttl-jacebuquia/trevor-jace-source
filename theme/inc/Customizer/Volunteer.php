...
class Volunteer extends Abstract_Customizer {
	...
	protected function _register_panels(): void {
		$this->_manager->add_panel( self::PANEL_ID, [ 'title' => 'Volunteer' ] );
	}
	...
	protected function _register_controls(): void {
		...
		## 1
		$this->_manager->add_control( new \WP_Customize_Media_Control( $this->_manager, self::SETTING_HOME_1_IMG, [
		...
		## 3
		$this->_manager->add_control( new \WP_Customize_Media_Control( $this->_manager, self::SETTING_HOME_3_IMG, [
			'setting'   => self::SETTING_HOME_3_IMG,
			'section'   => self::SECTION_HOME_GENERAL,
			'label'     => '[3] Image',
			'mime_type' => 'image',
		] ) );
		$this->_manager->add_control( self::SETTING_HOME_3_DESC, [
		...
		$this->_manager->add_control( new Control\Custom_List( $this->_manager, self::SETTING_HOME_TESTIMONIALS, [
