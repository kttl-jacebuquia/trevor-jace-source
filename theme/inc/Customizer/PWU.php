...
class PWU extends Abstract_Customizer {
	...
	protected function _register_panels(): void {
		$this->_manager->add_panel( self::PANEL_ID, array( 'title' => 'Partner With Us' ) );
	}
	...
	protected function _register_controls(): void {
		...
		$this->_manager->add_control(
			new Control\Custom_List(
				$this->_manager,
				self::SETTING_HOME_HERO_CAROUSEL_DATA,
				array(
		...
		$this->_manager->add_control(
			self::SETTING_HOME_OUR_PHILOSOPHY_TITLE,
			array(
		...
		$this->_manager->add_control(
			self::SETTING_HOME_OUR_PHILOSOPHY_DESC,
			array(
		...
		$this->_manager->add_control(
			self::SETTING_HOME_OUR_PARTNERSHIP_OFFERINGS_TITLE,
			array(
		...
		$this->_manager->add_control(
			self::SETTING_HOME_OUR_PARTNERSHIP_OFFERINGS_DESC,
			array(
