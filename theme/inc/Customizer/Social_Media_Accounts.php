...
class Social_Media_Accounts extends Abstract_Customizer
{
  ...
  protected function _register_controls(): void {
    $this->_manager->add_control( self::SETTING_HOME_FACEBOOK_URL, [
    ...
    $this->_manager->add_control( self::SETTING_HOME_TWITTER_URL, [
    ...
    $this->_manager->add_control( self::SETTING_HOME_TIKTOK_URL, [
    ...
    $this->_manager->add_control( self::SETTING_HOME_YOUTUBE_URL, [
