...
class Product_Partnerships extends Abstract_Customizer {
	...
	protected function _register_panels(): void {
		$this->_manager->add_panel( self::PANEL_ID, array( 'title' => 'Product Partnerships' ) );
	}
	...
	protected function _register_controls(): void {
		...
		$this->_manager->add_control(
			self::SETTING_HOME_CURRENTS_TITLE,
			array(
