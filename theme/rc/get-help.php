...
<main id="site-content" role="main" class="site-content get-help">
	<div>
		<div class="container mx-auto text-center site-content-inner">
			...
			<p class="text-px18 font-normal mx-4 mb-10 text-indigo md:text-px20 md:leading-px30 md:mx-px88 md:mb-12 lg:text-px22 lg:leading-px36 lg:mb-14 xl:mx-52"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_1_DESC ) ?></p>
			...
			<div class="mt-7 mb-14 text-center text-indigo md:mb-20 lg:mt-32 xl:mx-52">
				...
				<p class="font-normal text-px20 leading-px30 md:mx-6 lg:text-px22 lg:leading-px36 lg:mx-0"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_2_DESC ) ?></p>
			</div>
			...
			<div class="flex flex-col items-center bg-white rounded-px10 mb-20 py-14 px-7 text-indigo md:py-12 md:px-10 md:mb-px88 xl:mx-px106 lg:px-px106 lg:py-px72 lg:mb-28">
				<p class="text-px18 leading-px22 tracking-px05 mb-6 md:text-px20 md:leading-px30 md:mb-7 lg:text-px20 lg:leading-px32"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_NOTIFICATION_TXT ) ?></p>
