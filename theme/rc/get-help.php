...
<main id="site-content" role="main" class="site-content">
	<div>
		<div class="container mx-auto text-center site-content-inner">
			<h1 class="flex flex-col justify-center font-bold text-px38 leading-px42 tracking-em001 text-indigo mb-2.5 md:flex-row md:mb-4 md:text-px36 md:leading-px46 lg:text-px52 lg:leading-px62"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_1_TITLE ) ?></h1>
			...
			<div class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 md:mx-px60 lg:mx-80">
				<a href="#" class="btn flex flex-col text-px20 leading-px22 pt-4 pb-5 px-4 flex-1 justify-center md:p-8">
			...
			<div class="flex flex-col mb-px72 md:flex-row lg:mx-px106 lg:mb-28">
				...
				<div class="text-center text-indigo px-5 md:flex-1 md:flex md:flex-col md:justify-center md:items-center">
					...
					<a href="#" class="btn block text-center text-px18 leading-px24 mb-4 md:text-px16 md:leading-px22"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_TEXT_CTA ) ?></a>
					<a href="#" class="btn-link text-px18 leading-px24">What to expect +</a>
				</div>
			</div>
			<div class="flex flex-col mb-px72 md:flex-row-reverse lg:mx-px106 lg:mb-28">
				...
				<div class="text-center text-indigo px-5 md:flex-1 md:flex md:flex-col md:justify-center md:items-center">
					...
					<a href="#" class="btn block text-center text-px18 leading-px24 mb-4 md:text-px16 md:leading-px22"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_CALL_CTA ) ?></a>
					<a href="#" class="btn-link text-px18 leading-px24">What to expect +</a>
				</div>
			</div>
			<div class="flex flex-col mb-20 md:flex-row lg:mx-px106 lg:mb-28">
				...
				<div class="text-center text-indigo px-5 md:flex-1 md:flex md:flex-col md:justify-center md:items-center">
					...
					<a href="#" class="btn block text-center text-px18 leading-px24 mb-4 md:text-px16 md:leading-px22"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_CHAT_CTA ) ?></a>
					<a href="#" class="btn-link text-px18 leading-px24">What to expect +</a>
				</div>
			</div>
	...
	<div class="bg-violet-lighter">
		<div class="container mx-auto text-center text-indigo site-content-inner">
			<div class="flex flex-col items-center py-64 md:py-72 lg:py-64">
				<h4 class="font-semibold text-px38 leading-px48 mb-4 md:text-px32 md:leading-px42 lg:text-px46 lg:leading-px56"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_EXERCISE_TITLE ) ?></h4>
				<p class="text-px20 leading-px30 mb-10 md:text-px16 md:leading-px22 md:mb-px30 md:mx-12 lg:text-px22 lg:leading-px34 lg:mx-80 lg:mb-10"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_EXERCISE_DESC ) ?></p>
				<a href="#" class="btn btn-secondary inline-flex text-px18 leading-px24 md:text-px16 md:leading-px22"><?= Resource_Center::get_val( Resource_Center::SETTING_GET_HELP_EXERCISE_CTA ) ?></a>
			</div>
		</div>
	</div>
