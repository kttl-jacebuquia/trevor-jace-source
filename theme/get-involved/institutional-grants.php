...
<main id="site-content" role="main" class="site-content institutional-grants">
	...
	<div class="funders bg-white flex flex-col">
		<h2 class="funders__title text-px32 leading-px40 md:leading-px42 lg:text-px40 lg:leading-px48 mt-px60 mb-px50 md:mb-px40 lg:mt-px100 lg:mb-px50 text-center font-bold">Current Funders</h2>
