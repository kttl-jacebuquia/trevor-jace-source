...
-->
	<div class="hero h-px600 md:h-px490 lg:h-px737 flex items-center text-white">
		<div class="container mx-auto text-center site-content-inner items-center md:pr-60 md:text-left lg:px-52 md:items-start md:py-18 lg:items-start lg:mr-96">
			<h1 class="text-px32 leading-px40 mb-3 flex flex-col font-bold md:inline-block md:mb-3 lg:text-px46 lg:leading-px56 lg:mr-16 tracking-em005">Creating a more <tilt class="text-5xl mb-2 md:mr-2 lg:text-px70 lg:leading-px80">inclusive world</tilt></h1>
			<p class="mb-9 md:text-px14 md:leading-px20 lg:text-px22 lg:leading-px32">Through legislation, litigation and public education, The Trevor Project is the leading advocate for LGBTQ youth in preventative efforts that address the discrimination, stigma and other factors that place LGBTQ youth at significantly higher risk of suicide.</p>
	...
	<div class="py-20 text-white bg-teal-dark">
		<div class="container mx-auto site-content-inner text-center">
			<h2 class="font-semibold text-px32 leading-px42 mb-10 md:mx-40 md:mb-px50 lg:text-px46 lg:leading-px56 lg:mb-px60"><?= Advocacy::get_val( Advocacy::SETTING_HOME_CAROUSEL_TITLE ) ?></h2>

			<div class="mb-8">
				<div class="lg:flex lg:flex-row lg:flex-nowrap lg:justify-center">
					<div class="slide text-center lg:w-2/3">
						<picture class="rounded-px10">
							<source srcset="http://placehold.it/818x500" media="(min-width: 1440px)">
							<source srcset="http://placehold.it/668x409" media="(min-width: 768px)">
							<img class="mb-7 md:flex-1 rounded-px10 lg:mx-auto" src="http://placehold.it/319x319" alt="" />
						</picture>
						<p class="text-px18 leading-px26 md:text-px14 md:leading-px20 lg:text-px18 lg:leading-px26 tacking-em005 lg:mx-20">The Rally to Prevent Suicide in 2018.Volutpat maecenas a mollis est luctus faucibus velit quis neque. Enim sapien vel et dui quis.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="pt-20 pb-px60 text-white lg:pt-28 lg:pb-48">
		...
		<div class="accordion text-teal-dark text-left bg-white md:grid md:grid-cols-2 md:gap-7 md:mx-px50 md:bg-transparent lg:grid-cols-3 lg:mx-px106" id="accordionExample">
			<div class="accordion-item md:rounded-px10 md:bg-white md:shadow-md">
				<h2 class="accordion-header" id="headingOne">
					<button class="accordion-button text-px20 leading-px26 py-8 px-7 w-full text-left border-b border-blue_green border-opacity-20 flex justify-between font-semibold md:pt-9 md:mb-3 md:border-0 md:pb-0 md:text-px24 md:leading-px28" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
						Ending Conversion Therapy
					</button>
				</h2>
				<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
					<div class="accordion-body px-7 pt-5 pb-9 bg-gray-light md:bg-transparent md:pb-36">
						<p class="text-px18 leading-px28 mb-6 md:text-px16 md:leading-px24">The largest campaign in the nation working to protect LGBTQ youth from conversion therapy.</p>
			...
			<div class="accordion-item md:rounded-px10 md:bg-white md:shadow-md">
				<h2 class="accordion-header" id="headingTwo">
					<button class="accordion-button text-px20 leading-px26 py-8 px-7 w-full text-left border-b border-blue_green border-opacity-20 flex justify-between font-semibold collapsed md:pt-9 md:mb-3 md:border-0 md:pb-0 md:text-px24 md:leading-px28" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
						Collecting LGBTQ Life Data
					</button>
				</h2>
				<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
					<div class="accordion-body px-7 pt-5 pb-9 bg-gray-light md:bg-transparent md:pb-36">
						<p class="text-px18 leading-px28 mb-6 md:text-px16 md:leading-px24">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Odio lorem pellentesque facilisis fermentum nisl neque id. Integer.</p>
						<a class="font-bold text-px18 leading-px28 border-b-2 border-teal-dark" href="#">Read more</a>
					</div>
				</div>
			</div>
			<div class="accordion-item md:rounded-px10 md:bg-white md:shadow-md">
				<h2 class="accordion-header" id="headingThree">
					<button class="accordion-button text-px20 leading-px26 py-8 px-7 w-full text-left border-b border-blue_green border-opacity-20 flex justify-between font-semibold collapsed md:pt-9 md:mb-3 md:border-0 md:pb-0 md:text-px24 md:leading-px28" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
			...
			<div class="accordion-item md:rounded-px10 md:bg-white md:shadow-md">
				<h2 class="accordion-header" id="headingFour">
					<button class="accordion-button text-px20 leading-px26 py-8 px-7 w-full text-left border-b border-blue_green border-opacity-20 flex justify-between font-semibold collapsed md:pt-9 md:mb-3 md:border-0 md:pb-0 md:text-px24 md:leading-px28" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
						Research Studies
					</button>
				</h2>
			...
			<div class="accordion-item md:rounded-px10 md:bg-white md:shadow-md">
				<h2 class="accordion-header" id="headingFive">
					<button class="accordion-button text-px20 leading-px26 py-8 px-7 w-full text-left border-b border-blue_green border-opacity-20 flex justify-between font-semibold collapsed md:pt-9 md:mb-3 md:border-0 md:pb-0 md:text-px24 md:leading-px28" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
						Resources & Guides
					</button>
				</h2>
	...
	<div class="h-px737 bg-canary lg:h-px600 lg:flex lg:items-center">
		<figure class="pt-20 pb-28 container text-left text-teal-dark md:flex-1 md:px-24 md:pt-24 md:pb-20 lg:ml-56 lg:p-0 lg:w-5/12 lg:flex-initial">
			...
			<blockquote class="font-bold text-3xl my-4 md:text-px30 md:leading-px40 md:mr-24 lg:text-px40 lg:leading-px48 lg:font-semibold">Thank you for everything you do for our community and humans around  the world.</blockquote>
		...
		<div class="container mx-auto site-content-inner text-center">
			...
			<div class="grid grid-cols-1 gap-y-7 mb-10 md:grid-cols-2 md:gap-7 lg:grid-cols-3">
				<div class="bg-white text-teal-dark rounded-px10 text-left px-7 pt-7 pb-16 md:shadow-md">
					...
					<p class="text-px16 leading-px24 mb-4">We know that LGBT people face disparities in nearly every realm of life, such as mental health and substance use disparities, barriers in access to health insurance cov...</p>
					<a class="font-bold text-px18 leading-px24 tracking-em001 border-b-2 border-teal-dark" href="#">Read more</a>
				</div>
				<div class="bg-white text-teal-dark rounded-px10 text-left px-7 pt-7 pb-16 md:shadow-md">
					<p class="text-px16 leading-px24 tracking-em_001 font-semibold mb-3.5">H.R. 2913 / S. 1370</p>
					<h3 class="text-px24 leading-px28 tracking-em001 font-semibold mb-3">Mental Health In Schools Act</h3>
					<p class="text-px16 leading-px24 mb-4">The Mental Health In Schools Act will provide $200,000,000 in competitive grants of up to $1 million each. It expands th...</p>
					<a class="font-bold text-px18 leading-px24 tracking-em001 border-b-2 border-teal-dark" href="#">Read more</a>
				</div>
				<div class="bg-white text-teal-dark rounded-px10 text-left px-7 pt-7 pb-16 md:shadow-md">
					<p class="text-px16 leading-px24 tracking-em_001 font-semibold mb-3.5">H.R. 2119 / S. 928</p>
					<h3 class="text-px24 leading-px28 tracking-em001 font-semibold mb-3">Therapeutic Fraud Prevention Act of 2017</h3>
					<p class="text-px16 leading-px24 mb-4">In relation to the same important topic addressed with the Stop Harming Our Kids Resolution of 2015 , the Ther...</p>
					<a class="font-bold text-px18 leading-px24 tracking-em001 border-b-2 border-teal-dark" href="#">Read more</a>
				</div>
			</div>

			<a class="font-bold text-px24 leading-px34 tracking-em001 border-b-2 border-white text-white mb-px50 self-center md:mb-20" href="#">View All</a>
			...
			<div class="grid grid-cols-1 gap-y-7 mb-10 md:grid-cols-2 md:gap-7 lg:grid-cols-3">
				<div class="bg-white text-teal-dark rounded-px10 text-left px-7 pt-7 pb-24 md:shadow-md">
					<h3 class="text-px24 leading-px28 tracking-em001 font-semibold mb-3">Et fringilla nibh aliquam gravida malesuada nec.</h3>
					<p class="text-px16 leading-px24 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus tristique sed tincidunt rhoncus amet posuere leo quisque eget. </p>
					<a class="font-bold text-px18 leading-px24 tracking-em001 border-b-2 border-teal-dark" href="#">Read the Letter <i class="trevor-ti-download text-px16 ml-2"></i></a>
				</div>
				<div class="bg-white text-teal-dark rounded-px10 text-left px-7 pt-7 pb-24 md:shadow-md">
					<h3 class="text-px24 leading-px28 tracking-em001 font-semibold mb-3">Et fringilla nibh aliquam gravida malesuada nec.</h3>
					<p class="text-px16 leading-px24 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus tristique sed tincidunt rhoncus amet posuere leo quisque eget. </p>
			...
			<a class="font-bold text-px24 leading-px34 tracking-em001 border-b-2 border-white text-white mb-10 self-center" href="#">View All</a>
			<a href="#" class="inline-block font-bold text-indigo bg-white py-3 px-8 rounded-px10 md:px-8 lg:text-px20 lg:leading-px26 lg:py-5 lg:px-10 self-center"><?= Advocacy::get_val( Advocacy::SETTING_HOME_TAN_CTA ) ?></a>
		</div>
	</div>
	...
	<div class="pt-20 pb-20 text-teal-dark bg-white lg:pt-28 lg:pb-48">
		<div class="container mx-auto site-content-inner text-center">
			...
			<a class="font-bold text-px24 leading-px34 tracking-em001 border-b-2 border-teal-dark text-teal-dark mb-px50 self-center" href="#">Load More</a>
		</div>
	</div>
</main>
<?php get_footer(); ?>
