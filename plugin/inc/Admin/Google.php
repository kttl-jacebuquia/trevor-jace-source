		...
		<div class="wrap">
			...
			<div class="app-wrap">
				...
				if ( $has_token ) {
					...
					<script>
						jQuery(function () {
							TrevorWP.adminApps.google(document.getElementById('app-root'), <?php echo json_encode( $options ); ?>);
						});
					</script>
					<?php
				} else {
					?>
					<p>
						To be able to use this feature please <a href="<?php echo esc_attr( $auth_url ); ?>">authorize</a>.
					</p>
					<?php
				}
				?>
